...
Version 0.3.0, usable but young. The desktop client was rewritten on relm4 and
...
just install-desktop # desktop entry and icons, so the shell has an icon for the window
```
